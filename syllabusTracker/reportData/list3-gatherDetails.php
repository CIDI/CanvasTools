			...
			<div id="collegeList">
					<?php
						...
						for ($j=0; $j<$departmentCount; $j++){
							$jsonData .= '{"deptName": '.json_encode($data[0]['departments'][$j]['deptName']).',';
							...
							for ($k=0; $k<$courseCount; $k++){
								...
								$jsonData .= '"courseName": '.json_encode($data[0]['departments'][$j]['courses'][$k]['courseName']).',';
									  	...
									  	if($instructorCount>1){
											echo '<li>'.$courseID.' - >1 ('.strlen($syllabusBody).')</li>';
										  	...
										  	for($instructor=0; $instructor<$instructorCount; $instructor++){
										  		...
										  		$jsonData .= '{"instructorName": '.json_encode($instructorName).'},';
										  	}
